...
如表 3-4 所示，simpleFizzBuzz 方法有 4
...
实际上这里只是使用了一种语法糖，通过\@RunWith注解输入 Parameterized
...
![](./03-unit-testing-fundamentals/media/image6.png){width="6.027777777777778in"
...
如果我们不需要保留对JUnit 4的兼容，可以不加入 JUnit
